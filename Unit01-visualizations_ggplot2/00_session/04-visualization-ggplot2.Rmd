...
The `theme` call angles the x-axis labels to 45 degrees so they don't overlap: 
we will learn more about `theme` later in the lesson.
...
>
> So far, we've looked at the distribution of diameter within periods. Try making
> a new plot to explore the distribution of another variable within each period.
>
...
Unfortunately, this does not work because we plotted data for all the decoration types
...
We will be able to distinguish decoration types in the plot if we add colors (using
...
> of each period changes through the years.
>
